...
!  SFM  end    07/29/2014
  ...
  integer :: nmemb1,ic
  integer :: nxu,nyu
  integer :: ink,nx, ny, i, j, k, i1, iprint
  integer :: ipias(2)
  integer :: ipol(15), ifreq(15), iobs(15)
...
!  enddo
  ...
  do k=1,88
     do i1=1,nmemb1
        if(dPRRet%MS%log10dNw(i1,k,i,j)>5 .or. &
             dPRRet%MS%log10dNw(i1,k,i,j)<-5) then
           dPRRet%MS%log10dNw(i1,k,i,j)=dPRRet%log10dNw(i1,k,i,j)
        end if
     enddo
  end do
!end MG 9/18/13 
