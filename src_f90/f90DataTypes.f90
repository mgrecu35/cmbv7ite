...
!end    WSO 9/1/13
     ...
     !Modified env variables  that replace GANAL in the radarRet SJM 10/1/2020
     real, dimension(:,:,:), pointer :: modQv
     !real, dimension(:,:,:), pointer :: modPress
     real, dimension(:,:,:), pointer :: modTemp
     real, dimension(:,:,:), pointer :: modCloud
     real, dimension(:,:), pointer   :: modSfcWind
     real, dimension(:,:), pointer   :: modSfcWindU
     real, dimension(:,:), pointer   :: modSfcWindV
     real, dimension(:,:), pointer   :: modSknTemp
     real, dimension(:,:), pointer   :: modSfcTemp
     !real, dimension(:,:), pointer   :: modSfcPress
     !end SJM 10/1/2020
     !variables directly from GMI 1DVAR retrieval that go into OptEst output structure SJM 10/5/2020
     real, dimension(:,:,:), pointer :: OEQv !OptEst/vaporDensity
     real, dimension(:,:,:), pointer :: OETemp !OptEst/airTemperature
     real, dimension(:,:,:), pointer :: OECloud !OptEst/cloudLiqWaterCont
     real, dimension(:,:), pointer :: OECloudLiqPath !OptEst/columnCloudLiqSigma
     real, dimension(:,:), pointer :: OEcloudLiqSigma !OptEst/columnCloudLiqSigma
     real, dimension(:,:), pointer   :: OESfcWind !OptEst/tenMeterWindSpeed
     real, dimension(:,:), pointer   :: OESfcWindSigma !OptEst/tenMeterWindSpeedSigma
     real, dimension(:,:), pointer   :: OESknTemp !OptEst/skinTemperature
     real, dimension(:,:), pointer :: OEskinTempSigma !OptEst/skinTempSigma
     real, dimension(:,:), pointer   :: OESfcTemp !OptEst/surfaceAirTemperature
     real, dimension(:,:), pointer   :: OESfcQv !OptEst/surfaceVaporDensity
	 real,dimension(:,:), pointer :: OEtpw !OptEst/columnWaterVapor
	 real,dimension(:,:), pointer :: OEtpwSigma !OptEst/columnVaporSigma
     real, dimension(:,:), pointer :: OEchiSq !OptEst/errorOfDataFit
     real, dimension(:,:,:), pointer :: OEpiaNonRain !OptEst/piaNoPrecip
     real, dimension(:,:,:), pointer :: OEsimTbNonRain !OptEst/simulatedBrightTemp
     real, dimension(:,:,:), pointer :: OEemis !OptEst/surfEmissivity
     real, dimension(:,:,:), pointer :: OEemisSigma !OptEst/surfEmissSigma
     real, dimension(:,:,:), pointer :: OEemisA !OptEst/emissivityAvgKernel
     integer, dimension(:,:), pointer   :: OEstype !OptEst/surfaceClass
 ...
 type cGMIDataType
     ...
     real, pointer :: SCAlt(:) !SJM 8/26/20
     integer, pointer :: SCYaw(:) !SJM 8/26/20
     real, pointer :: S1eia(:,:) !SJM 8/4/16
     real, pointer :: S2eia(:,:) !SJM 8/4/16
     real, pointer :: S1sga(:,:) !SJM 8/26/20
