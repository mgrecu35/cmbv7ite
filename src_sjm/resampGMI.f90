...
!!print*,'  reSampleGMI',i1,i2,gMIData%nS2f,gMIData%n1b11H
  ...
  !print*, gMIData%nS2f,gMIData%nrays,gMIData%n1b11H
...
!  print*, gmiData%S1lon3(70,:)
  ...
  call interpol3x(gMIData%gmiS2(3,:,i1:i2),gMIData%gmiS23(3,:,:),i2-i1+1) !SJM 8/14/20
  call interpol3x(gMIData%gmiS2(4,:,i1:i2),gMIData%gmiS23(4,:,:),i2-i1+1) !SJM 8/14/20
