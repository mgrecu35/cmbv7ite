...
!   endif
  ...
  do j=1,dPRData%n1c21
     do i=1,49
        ...
        !print '(2I5,2F8.2,F5.2)', j,i,eLon,eLat,wfmap(i,j)
        ...
        if(dPRData%xlon(i,j)>-998) then  !4/15/14 MG begin
           ...
           !print*,iGMI,jGMI
           gmitb_dpr(:) = missing_r4
           if(iGMI>0 .and. jGMI>0 .and. gmi2Grid%xmin>-998 ) then !4/22/14 MG
              !Run all sky retrieval here
              !print*, dPRData%xlon(i,j), dPRData%xlat(i,j), gmiData%gmiS13(1:9,iGMI,jGMI), gmiData%gmiS23(1:4,iGMI,jGMI)
              gmitb_dpr(1:9) =  gmiData%gmiS13(1:9,iGMI,jGMI)
              gmitb_dpr(10:13) = gmiData%gmiS23(1:4,iGMI,jGMI)
           ...
           write(12), i,j, dPRData%xlon(i,j), dPRData%xlat(i,j), gmitb_dpr, dPRData%sigmaZeroKu(i,j), dPRData%sigmaZeroKa(i,j)
